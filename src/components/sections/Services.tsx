...
const ServiceCard = ({ icon: Icon, titleKey, descKey, delay }: any) => {
  ...
  return (
    <motion.div
      ...
      className="service-card glass p-8 rounded-2xl group hover:border-primary/50 transition-all duration-500 relative overflow-hidden"
    >
